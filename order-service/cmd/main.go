...
import (
	...
	"github.com/Fipaan/ap2-uni/order-service/internal/app"
	orderV1 "github.com/Fipaan/ap2-uni-op-gen/order-service/proto/v1"
...
func main() {
	...
	r.GET("/orders/list", App.Handler.GetPaymentsList)
